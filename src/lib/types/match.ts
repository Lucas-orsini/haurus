...
export const METRIC_DEFS: MetricDef[] = [
  ...
  { label: 'Taux de victoire JJ',        p1Key: 'win_rate_td_p1',        p2Key: 'win_rate_td_p2',        mode: 'higher'     },
  { label: 'Taux de victoire surface JJ',p1Key: 'win_rate_surf_td_p1',   p2Key: 'win_rate_surf_td_p2',   mode: 'higher'     },
  ...
  { label: 'Breaks perdus',              p1Key: 'breaks_lost_td_p1',     p2Key: 'breaks_lost_td_p2',     mode: 'breaks_lost'},
