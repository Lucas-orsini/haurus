      ...
      <div className="flex items-center gap-2 px-2 mb-6 shrink-0">
        <div className="w-6 h-6 rounded-md bg-[var(--accent)] flex items-center justify-center shrink-0">
          <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" className="w-3.5 h-3.5">
            ...
            <path d="M12 2a10 10 0 0 0-4 7.5" />
            <path d="M2 12h10" />
            <path d="M12 12l4-2" />
          </svg>
        </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                'border-l-2 pl-[6px]',
                isActive
                  ? 'bg-white/[0.07] text-[var(--text-1)] font-medium border-[var(--accent)]'
                  : 'text-[var(--text-3)] hover:text-[var(--text-2)] hover:bg-white/[0.03] border-transparent'
              )}
            >
      ...
      <div className="shrink-0 border-t border-[var(--border)] pt-3 mt-2">
        <div className="flex items-center gap-2.5 px-2 py-2">
          <div className="w-6 h-6 rounded-full bg-[var(--surface-3)] flex items-center justify-center shrink-0">
            <span className="text-[10px] text-[var(--text-2)] font-medium">JD</span>
          </div>
