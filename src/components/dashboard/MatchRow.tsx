...
export const METRIC_DEFS: MetricDef[] = [
  ...
  { label: 'Taux de victoire',      p1Key: 'win_rate_td_p1',        p2Key: 'win_rate_td_p2',        mode: 'higher'  },
  { label: 'Taux de victoire Surface', p1Key: 'win_rate_surf_td_p1', p2Key: 'win_rate_surf_td_p2', mode: 'higher'  },
  { label: 'Momentum JJ',           p1Key: 'momentum_td_p1',        p2Key: 'momentum_td_p2',        mode: 'higher'  },
  { label: 'Breaks gagnés',         p1Key: 'breaks_won_td_p1',      p2Key: 'breaks_won_td_p2',      mode: 'higher'  },
  { label: 'Breaks perdus',        p1Key: 'breaks_lost_td_p1',     p2Key: 'breaks_lost_td_p2',     mode: 'lower'   },
...
export const METRIC_TOOLTIPS: Record<string, string> = {
  ...
  'Évolution rank 6 mois': "Variation du classement ATP sur les 6 derniers mois. Une valeur négative signifie que le joueur a progressed au classement.",
  ...
  'Taux de victoire': 'Pourcentage de victoires du joueur sur la période récente, toutes surfaces confondues. Les matchs récents ont plus de poids que les anciens.',
  'Taux de victoire Surface': 'Pourcentage de victoires du joueur sur la surface de ce tournoi, calculé sur la période récente. Capture la spécialisation sur cette surface.',
  'Momentum JJ': 'Compare la forme très récente du joueur à sa forme habituelle sur cette surface. Une valeur positive signifie qu\'il surperforme en ce moment, négative qu\'il est en dessous de son niveau habituel.',
  'Breaks gagnés': 'Nombre moyen de breaks de service réalisés par match sur cette surface récemment. Mesure la capacité à concrétiser les opportunités sur le service adverse.',
  'Breaks perdus': 'Nombre moyen de breaks concédés par match sur cette surface récemment. Plus la valeur est basse, mieux le joueur tient son service sous pression.',
