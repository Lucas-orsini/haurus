...
/*
 * ─────────────────────────────────────────────────────────────────────────────
 * Ancienne grille de plans payants — conservée en commentaire pour réactivation
 * ─────────────────────────────────────────────────────────────────────────────
...
// Rendu grille 3 cards (ancien) — à remplacer par le code ci-dessous si réactivation :
/*
{plans.map((plan) => (
  <motion.div
    key={plan.name}
...
const betaFeatures = [
  'Accès complet à toutes les métriques ATP (Glicko-2, BPPI, TSD, Momentum TD)',
  'Suivi de tous les joueurs sans limite',
  'Historique complet des matchs et statistiques de surface',
  'Alertes match en temps réel',
  'Dashboard dédié avec visualisations avancées',
]
    ...
    <section id="pricing" className="py-24 px-6 relative">
      ...
      >
        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-[var(--border-md)] bg-[var(--surface-2)] mb-6">
          <span className="text-[11px] font-medium text-[var(--text-2)] uppercase tracking-widest">Accès</span>
        </span>
        <h2 className="text-3xl md:text-4xl font-medium tracking-tight text-[var(--text-1)] mb-4">
          Accès Beta — 100% gratuit
        </h2>
        <p className="text-[var(--text-2)] max-w-md mx-auto text-sm leading-relaxed">
          Toutes les fonctionnalités sont disponibles dès maintenant, sans engagement.
          Rejoignez la beta et aidez-nous à construire le meilleur outil d'analyse tennis.
        </p>
      </motion.div>
      ...
      >
        <div
          className={cn(
            'relative rounded-2xl flex flex-col gap-6 p-8 overflow-hidden',
            'border-2 border-[var(--accent)] bg-[var(--surface-1)]',
            'shadow-[0_0_48px_rgba(242,203,56,0.10)]'
          )}
        >
          {/* Radial glow */}
          <div className="absolute inset-0 rounded-2xl pointer-events-none overflow-hidden">
            <div
              className="absolute top-0 left-1/2 -translate-x-1/2 w-72 h-36 opacity-8"
              style={{ background: 'radial-gradient(ellipse at center, rgba(242,203,56,0.5) 0%, transparent 70%)' }}
            />
          </div>

          {/* Badge */}
          <div className="relative z-10 flex items-center gap-2">
            <span className="px-3 py-1 rounded-full bg-[var(--accent)] text-black text-[11px] font-semibold flex items-center gap-1.5">
          ...
          {/* Card header */}
          <div className="relative z-10">
            <p className="text-xs font-semibold uppercase tracking-widest text-[var(--text-3)] mb-1">
              Toutes les fonctionnalités
            </p>
            <div className="flex items-end gap-2 mt-2">
              <span className="text-5xl font-bold text-[var(--text-1)] tracking-tight">Gratuit</span>
            </div>
            <p className="text-sm text-[var(--text-2)] mt-4 leading-relaxed">
              Accédez sans limite a l&apos;ensemble des métriques, joueurs et fonctionnalités du dashboard Haurus.
