...
- Authentication validators (input validation, format checking)
- Authentication flows (login, logout, session handling)
- Dashboard formatting utilities (metric display, number formatting)
- Dashboard statistics (stat calculations, data aggregation)
- General utility functions (common helper functions used across the app)

## 📁 Project Structure

- `src/components/dashboard/player` — Player profile components and client-side rendering logic
